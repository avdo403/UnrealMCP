...
public:
    ...
    static void AddVectorToJson(TSharedPtr<FJsonObject> JsonObject, const FString& FieldName, const FVector& Vector);
    static void AddRotatorToJson(TSharedPtr<FJsonObject> JsonObject, const FString& FieldName, const FRotator& Rotator);
