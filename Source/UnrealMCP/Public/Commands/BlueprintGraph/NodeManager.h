...
class UNREALMCP_API FBlueprintNodeManager
{
	public:
		...
		static TSharedPtr<FJsonObject> ResetNodePins(const TSharedPtr<FJsonObject>& Params);
		static TSharedPtr<FJsonObject> ImportNodesFromT3D(const TSharedPtr<FJsonObject>& Params);
	...
	private:
		 ...
		 * @return Created node or nullptr
		 */
		static class UK2Node* CreateEventNode(class UEdGraph* Graph, const TSharedPtr<FJsonObject>& Params);
