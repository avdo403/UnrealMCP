...
public:
	...
	/**
	 * Creates an Interface Call node
	 */
	static UK2Node* CreateInterfaceCallNode(UEdGraph* Graph, const TSharedPtr<class FJsonObject>& Params);

	/**
	 * Creates a Macro Call node
	 */
	static UK2Node* CreateMacroCallNode(UEdGraph* Graph, const TSharedPtr<class FJsonObject>& Params);
};
